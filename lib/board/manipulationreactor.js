    ...
    function toggleManipulator(cellView, evt) {
        ...
        if (!bundle) {
            ...
            if(bundle.view.model.attributes.pattern){
                if(_.filter(bundle.view.model.attributes.pattern, function (p) {return p.type === 'root'}).length > 0) {
                  (function () {
...
exports.delete = {
    ...
    popover: function (view) {
        if(view.model.attributes.pattern && view.model.attributes.pattern.length > 0) {
              $('#delete-icon').popover({
                title: "Warning",
