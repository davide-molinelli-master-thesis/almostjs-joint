...
function Board(options) {
    ...
    self.resizeElementVoiceAssistant = function (cell, delta, direction) {
        var cellViewSimulator = {
              model: cell
            }
        var resizeReactor = createResizeReactor({view: cellViewSimulator, paper: paper, model: model, el: el, direction: direction, gridSize: gridSize, undoReactor: undoReactor});
